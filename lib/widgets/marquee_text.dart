            ...
            ? Row(
                children: [
                  const Padding(
                    ...
                    child: Icon(Icons.star_rounded, color: Color(0xFFE957C9), size: 14,),
                  ),
                  RichText(
                    text: const TextSpan(
                      children: [
                        TextSpan(text:"Limited-time offer! ", style: TextStyle(
                          fontFamily: "custom",
                        ...
                        TextSpan(text:"Get 50% off", style: TextStyle(
                          fontFamily: "custom",
                          fontWeight: FontWeight.w600,
                          fontSize: 12,
                          height: 1,
                        ...
                        TextSpan(text:" on your first treatment and take control of your health today", style: TextStyle(
                          fontFamily: "custom",
                          fontWeight: FontWeight.w600,
                          fontSize: 12,
                          color: Color(0xFFE8D48F)
